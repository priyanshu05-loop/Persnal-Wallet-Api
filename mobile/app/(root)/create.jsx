...
const CreateScreen = () => {
  ...
  const handleCreate = async () => {
    //validation
    if (!user || !user.id) {
    Alert.alert("Error", "User not loaded. Please sign in again.");
    return;
  }
    if (!title.trim())
    ...
    setIsLoading(true);
    try {
      //formate the amount (-ve for expense and +ve for income)
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || "failed to create transation");
      }
